...
{
	console.log("changeColor() func Called: " + color);
...
function loadStatsPage()
{
	...
	{
		var home = parseInt(row.cells[2].innerHTML, 10);
		var opp = parseInt(row.cells[3].innerHTML, 10);
	...
	document.getElementById("losses").innerHTML = awayWins;
}
...
{
	var mydropown = document.getElementById("player_selector");
	var InnerHtml = "";
	...
	mydropown.innerHTML = InnerHtml;
}

function switchPlayers(playerNum)
{
	console.log("switch players called")
